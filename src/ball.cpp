...
Ball::Ball(float x, float y, float z, color_t color) {
    ...
    vertex_buffer_data[count++] = 0.8f;
    vertex_buffer_data[count++] = 0.0f;
    vertex_buffer_data[count++] = -5.0f;

    vertex_buffer_data[count++] = 0.8f;
    vertex_buffer_data[count++] = 0.0f;
    vertex_buffer_data[count++] = -8.0f;
...
void Ball::draw(glm::mat4 VP) {
    ...
    Matrices.model *= translate * yaw * rotate * roll;
